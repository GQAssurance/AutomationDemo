...
from classes_mutex import CrashingSafeMutexLogger
import time
import threading


def threaded_tests(name: str, logger: CrashingSafeMutexLogger):
...
def safe_parallel_tests():
    ...
    logger = CrashingSafeMutexLogger()      # make our threadsafe logger object
